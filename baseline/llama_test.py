...
base_tokenizer = LlamaTokenizer.from_pretrained(base_dir).to(device)
base_tokenizer.pad_token_id=base_tokenizer.eos_token_id.to(device)
...
def process_batch(batch):
    ...
    generated_texts = base_tokenizer.batch_decode(outputs, skip_special_tokens=True).to(device)
